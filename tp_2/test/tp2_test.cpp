...
//------------------------------------------------------------------------------------------------ 2
TEST_CASE ( "TP2_Nuage::Iterateurs" ) {//2
 Polaire p1(12,34);
 Polaire p2(56,78);
 Polaire p3(90,12);
 Polaire p4(34,56);
...
//------------------------------------------------------------------------------------------------ 3
TEST_CASE ( "TP2_Nuage::BarycentreCartesien_V1" ) {//3
 Nuage<Cartesien> n;
...
//----------------------------------------------------------------------------------------------- 4a
TEST_CASE ( "TP2_Nuage::BarycentrePolaire_V1" ) {//4a
 Nuage<Polaire> n;
...
//----------------------------------------------------------------------------------------------- 4b
/*TEST_CASE ( "TP2_Nuage::BarycentrePolaire_V1" ) {//4b
 Nuage<Polaire> n;
